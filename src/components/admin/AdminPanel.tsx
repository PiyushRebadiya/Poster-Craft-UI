...
const mockData = {
  ...
  user_sub_categories: [
    { id: '1', user_categories_id: '1', name: 'Personal', created_at: '2024-01-15' },
    { id: '2', user_categories_id: '2', name: 'Small Business', created_at: '2024-01-16' },
    { id: '3', user_categories_id: '2', name: 'Enterprise', created_at: '2024-01-17' }
  ],
  users: [
    {
      id: '1',
  ...
  frame_sub_categories: [
    { id: '1', frame_categories_id: '1', name: 'Diwali', created_at: '2024-01-15' },
    { id: '2', frame_categories_id: '1', name: 'Christmas', created_at: '2024-01-16' },
    { id: '3', frame_categories_id: '2', name: 'Kids Birthday', created_at: '2024-01-17' }
  ],
  frames: [
    {
      id: '1',
...
export default function AdminPanel() {
  const [activeTable, setActiveTable] = React.useState<AdminTableType>('user_categories');
    ...
    switch (table) {
      ...
      case 'user_sub_categories':
        return {
          ...
          columns: [
            { key: 'user_categories_id', label: 'Parent Category', type: 'select' as const },
            { key: 'name', label: 'Name', type: 'text' as const },
            { key: 'created_at', label: 'Created At', type: 'date' as const }
          ],
          fields: [
            { 
              ...
              required: true,
              options: data.user_categories.map(cat => ({ value: cat.id, label: cat.name }))
            },
            { key: 'name', label: 'Sub Category Name', type: 'text' as const, required: true }
          ]
        };
        ...
        return {
          ...
          fields: [
            ...
            { 
              ...
              type: 'select' as const, 
              required: true,
              options: data.user_sub_categories.map(cat => ({ value: cat.id, label: cat.name }))
            },
            { key: 'name', label: 'Full Name', type: 'text' as const, required: true },
            { key: 'register_mobile', label: 'Register Mobile', type: 'tel' as const, required: true },
            { key: 'business_name', label: 'Business Name', type: 'text' as const, required: true },
            { key: 'mobile1', label: 'Primary Mobile', type: 'tel' as const, required: true },
            { key: 'mobile2', label: 'Secondary Mobile', type: 'tel' as const },
            { key: 'email', label: 'Email Address', type: 'email' as const, required: true },
            { key: 'address', label: 'Address', type: 'textarea' as const, required: true },
            { key: 'business_logo', label: 'Business Logo', type: 'file' as const },
            { key: 'business_logo2', label: 'Business Logo 2', type: 'file' as const },
            { key: 'profile_photo', label: 'Profile Photo', type: 'file' as const },
      ...
      case 'frame_sub_categories':
        return {
          ...
          columns: [
            { key: 'frame_categories_id', label: 'Parent Category', type: 'select' as const },
            { key: 'name', label: 'Name', type: 'text' as const },
            { key: 'created_at', label: 'Created At', type: 'date' as const }
          ],
          fields: [
            { 
              ...
              type: 'select' as const, 
              required: true,
              options: data.frame_categories.map(cat => ({ value: cat.id, label: cat.name }))
            },
            { key: 'name', label: 'Sub Category Name', type: 'text' as const, required: true }
          ]
        };
      ...
      case 'frames':
        return {
          title: 'Frames',
          columns: [
            { key: 'frame_categories_id', label: 'Category', type: 'select' as const },
            { key: 'frame_sub_categories_id', label: 'Sub Category', type: 'select' as const },
          ...
          fields: [
            ...
            { 
              ...
              type: 'select' as const, 
              required: true,
              options: data.frame_sub_categories.map(cat => ({ value: cat.id, label: cat.name }))
            },
            { key: 'frame_json', label: 'Frame JSON', type: 'textarea' as const, required: true },
            { 
              key: 'status', 
              label: 'Status', 
              type: 'select' as const, 
      ...
      case 'pricing_plans':
        return {
          ...
          fields: [
            { key: 'title', label: 'Plan Title', type: 'text' as const, required: true },
            ...
            { key: 'days', label: 'Validity Days', type: 'number' as const, required: true },
            { key: 'plan_permission', label: 'Plan Permissions', type: 'textarea' as const, required: true }
          ]
        };
      ...
      case 'subscriptions':
        return {
          ...
          columns: [
            ...
            { key: 'price', label: 'Price', type: 'text' as const },
            { key: 'subscription_status', label: 'Status', type: 'status' as const },
          ...
          fields: [
            ...
            { key: 'title', label: 'Plan Title', type: 'text' as const, required: true },
            { key: 'payment_id', label: 'Payment ID', type: 'text' as const, required: true },
            { key: 'price', label: 'Price', type: 'number' as const, required: true },
            ...
            { key: 'gst_name', label: 'GST Name', type: 'text' as const, required: true },
            { key: 'gst_no', label: 'GST Number', type: 'text' as const, required: true },
            ...
            { key: 'total_days', label: 'Total Days', type: 'number' as const, required: true },
            { 
        ...
        return {
          ...
          fields: [
            ...
            { 
              ...
              type: 'select' as const, 
              required: true,
              options: data.frames.map(frame => ({ value: frame.id, label: `Frame ${frame.id}` }))
            },
            { key: 'sent_time', label: 'Sent Time', type: 'date' as const, required: true },
            { 
              key: 'status', 
              label: 'Status', 
              type: 'select' as const, 
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <FormModal
        ...
        title={editingItem ? `Edit ${config.title.slice(0, -1)}` : `Add New ${config.title.slice(0, -1)}`}
